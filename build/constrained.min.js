...
(function (global){
function Expression(){this._left=null,this._right=null}function Addition(t,n){Expression.call(this),this.addExpressions(t,n)}function Subtraction(t,n){Expression.call(this),this.addExpressions(t,n)}function Multiplication(t,n){Expression.call(this),this.addExpressions(t,n)}function Division(t,n){Expression.call(this),this.addExpressions(t,n)}function Constraint(t,n,e,i){this._expression1=t,this._expression2=n,this._strength=e,this._weight=i,this._id=(constraintCount++).toString(),this._constraint=null}function Inequality(t,n,e,i,o){Constraint.call(this,t,n,e,i),this._operator=o}function Equality(t,n,e,i){Constraint.call(this,t,n,e,i)}function NumericalValue(t){this._value=t,Expression.call(this)}function ObjectBinder(t,n,e){this._object=t,this._property=n,this._id=e,this._value=t[n]}function Constant(t,n){return this instanceof Constant==!1?new Constant(t,n):(ObjectBinder.call(this,t,n,(constantCount++).toString()),void Expression.call(this))}function Variable(t,n){return this instanceof Variable==!1?new Variable(t,n):(this._onChange=null,this._onChangeParams=null,ObjectBinder.call(this,t,n,(variableCount++).toString()),Expression.call(this),void(this._variable=new cassowary.Variable({name:this._id,value:this._value})))}function ConstantHandle(t,n){this.constant=t,this.constraints=[n]}function System(){return this instanceof System==!1?new System:(this._solver=new cassowary.SimplexSolver,this._solver.autoSolve=!1,this._variables={},this._constraints={},this._variableIds=null,this._constants={},this._constantIds=null,this._onNewSolution=null,this._onNewSolutionParams=null,this._forceResolving=!0,void(this.optimalValue=0))}var cassowary=require("cassowary");Expression.prototype.addExpressions=function(t,n){this._left=t,this._right=n},Expression.prototype.construct=function(){},Addition.prototype=Object.create(Expression.prototype),Addition.prototype.constructor=Addition,Addition.prototype.construct=function(){var t=this._left.construct(),n=this._right.construct();return t.plus(n)},Subtraction.prototype=Object.create(Expression.prototype),Subtraction.prototype.constructor=Subtraction,Subtraction.prototype.construct=function(){var t=this._left.construct(),n=this._right.construct();return t.minus(n)},Multiplication.prototype=Object.create(Expression.prototype),Multiplication.prototype.constructor=Multiplication,Multiplication.prototype.construct=function(){var t=this._left.construct(),n=this._right.construct();return t.times(n)},Division.prototype=Object.create(Expression.prototype),Division.prototype.constructor=Division,Division.prototype.construct=function(){var t=this._left.construct(),n=this._right.construct();return t.divide(n)};var constraintCount=0;Constraint.prototype.getConstants=function(){for(var t=[],n=[this._expression1,this._expression2];0!==n.length;){var e=n.pop();null===e._left?e instanceof Constant&&t.push(e):(n.push(e._left),n.push(e._right))}return t},Constraint.prototype.getVariables=function(){for(var t=[],n=[this._expression1,this._expression2];0!==n.length;){var e=n.pop();null===e._left?e instanceof Variable&&t.push(e):(n.push(e._left),n.push(e._right))}return t},Inequality.prototype=Object.create(Constraint.prototype),Inequality.prototype.constructor=Inequality,Inequality.prototype.construct=function(){return this._constraint=new cassowary.Inequality(this._expression1.construct(),this._operator,this._expression2.construct(),this._strength,this._weight),this._constraint},Equality.prototype=Object.create(Constraint.prototype),Equality.prototype.constructor=Equality,Equality.prototype.construct=function(){return this._constraint=new cassowary.Equation(this._expression1.construct(),this._expression2.construct(),this._strength,this._weight),this._constraint},NumericalValue.prototype=Object.create(Expression.prototype),NumericalValue.prototype.constructor=NumericalValue,NumericalValue.prototype.construct=function(){return new cassowary.Expression(this._value)};var constantCount=0;Constant.prototype=Object.create(Expression.prototype),Constant.prototype.constructor=Constant,Constant.prototype.construct=function(){return new cassowary.Expression(this._object[this._property])},Constant.prototype.refresh=function(){return this._value!==this._object[this._property]?(this._value=this._object[this._property],!0):!1};var variableCount=0;Variable.prototype=Object.create(cassowary.Variable.prototype),Variable.prototype.constructor=Variable,Variable.prototype.construct=function(){return new cassowary.Expression(this._variable,1)},Variable.prototype.refresh=function(){return this._value!==this._variable.value?(this._object[this._property]=this._variable.value,null!==this._onChange&&this._onChange(this._onChangeParams,this._variable.value,this._value),this._value=this._variable.value,!0):!1},System.prototype.onNewSolution=function(t,n){return this._onNewSolution=t,this._onNewSolutionParams=n,this},System.prototype.minimize=function(t){if(t instanceof Variable==!0)this._solver.optimize(t._variable);else{var n=new Variable(this,"optimalValue");this.addConstraint(new Equality(n,t)),this._solver.optimize(n._variable)}return this._forceResolving=!0,this},System.prototype.maximize=function(t){return this.minimize(new Multiplication(t,new NumericalValue(-1)))},System.prototype.addConstraint=function(t){if(void 0!==this._constraints[t._id])return void console.warn("[System.addConstraint] Constraint already present in the system:",t);for(var n=t.getConstants(),e=0;e<n.length;e+=1){var i=n[e],o=i._id;void 0===this._constants[o]?this._constants[o]=new ConstantHandle(i,t):this._constants[o].constraints.push(t)}this._constantIds=Object.keys(this._constants);for(var s=t.getVariables(),r=0;r<s.length;r+=1){var a=s[r],u=a._id;void 0===this._variables[u]&&(this._variables[u]=a)}this._variableIds=Object.keys(this._variables);var c=t.construct();return this._solver.addConstraint(c),this._constraints[t._id]=t,this._forceResolving=!0,this},System.prototype.resolve=function(t){var n=this._forceResolving;this._forceResolving=!1;for(var e=0;e<this._constantIds.length;e+=1){var i=this._constantIds[e],o=this._constants[i],s=o.constant;if(s.refresh()){for(var r=o.constraints,a=0;a<r.length;a+=1){var u=r[a];this._solver.removeConstraint(u._constraint),u.construct(),this._solver.addConstraint(u._constraint)}n=!0}}if(n!==!1||t!==!0){this._solver.resolve();for(var c=!1,l=0;l<this._variableIds.length;l+=1){var p=this._variableIds[l];this._variables[p].refresh()===!0&&(c=!0)}return c===!0&&null!==this._onNewSolution&&this._onNewSolution(this._onNewSolutionParams),this}};var Constrained={System:System,Variable:Variable,Constant:Constant,plus:function(t,n){return"number"==typeof t&&(t=new NumericalValue(t)),"number"==typeof n&&(n=new NumericalValue(n)),new Addition(t,n)},minus:function(t,n){return"number"==typeof t&&(t=new NumericalValue(t)),"number"==typeof n&&(n=new NumericalValue(n)),new Subtraction(t,n)},times:function(t,n){return"number"==typeof t&&(t=new NumericalValue(t)),"number"==typeof n&&(n=new NumericalValue(n)),new Multiplication(t,n)},dividedBy:function(t,n){return"number"==typeof t&&(t=new NumericalValue(t)),"number"==typeof n&&(n=new NumericalValue(n)),new Division(t,n)},greaterThan:function(t,n,e,i){return"number"==typeof t&&(t=new NumericalValue(t)),"number"==typeof n&&(n=new NumericalValue(n)),new Inequality(t,n,e,i,cassowary.GEQ)},smallerThan:function(t,n,e,i){return"number"==typeof t&&(t=new NumericalValue(t)),"number"==typeof n&&(n=new NumericalValue(n)),new Inequality(t,n,e,i,cassowary.LEQ)},equals:function(t,n,e,i){return"number"==typeof t&&(t=new NumericalValue(t)),"number"==typeof n&&(n=new NumericalValue(n)),new Equality(t,n,e,i)}},root;"undefined"!=typeof window?root=window:"undefined"!=typeof global?root=global:(console.warn("[TINA] Your environment might not support TINA."),root=this),module.exports=root.Constrained=Constrained;
